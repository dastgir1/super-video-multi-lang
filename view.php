...
use mod_supervideo\output\language_player;
...
$directionattr = right_to_left() ? " dir=\"ltr\"" : "";

echo $OUTPUT->header();

echo "<div id=\"supervideo_area_embed\"{$directionattr}>";
echo language_player::render($cm, $course, $supervideo, $context);
echo '</div>';
